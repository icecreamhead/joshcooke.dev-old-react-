        ...
        <header className='App-header'>
          ...
          <p>
            <a href='https://travis-ci.org/icecreamhead/joshcooke.dev'>
              <img src='https://travis-ci.org/icecreamhead/joshcooke.dev.svg?branch=master'
                   alt='Travis CI Build Status'/>
            </a>
            <a title='joshcooke.dev on GitHub' rel='noopener noreferrer' target='_blank'
               href='https://github.com/icecreamhead/joshcooke.dev' id='ember151' className='repo-gh ember-view'>
